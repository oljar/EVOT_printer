...
#   AHU
   ...
   ###################  filter plate
        ...
        try:
            data_filter_plate_out['Wymiar'] = self.symbol_supply_filter_value.get() + ' / ' + self.quantity_supply_filter_value.get()
        except:
            data_filter_plate_out['Wymiar'] = ''
        ...
        try:
            data_filter_plate_out['Wymiar1'] = self.symbol_exhaust_filter_value.get() + ' / ' + self.quantity_exhaust_filter_value.get()
        except:
            data_filter_plate_out['Wymiar1'] = ''
